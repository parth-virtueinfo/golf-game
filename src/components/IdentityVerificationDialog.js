...
const IdentityVerificationDialog = ({
  ...
  setShowIdentityVerificationDialog,
  onModelClose,
  onPressContinue,
  onPressClose,
}) => {
  return (
    <Modal
      transparent={true}
      animationType={'slide'}
      visible={showIdentityVerificationDialog}
            ...
            <View>
              ...
              <View style={styles.content}>
                ...
                <CustomTextMonument mTop={13} size={32}>
                  {string.identity_verification_required}
                </CustomTextMonument>
                <View style={styles.container}>
                  <View style={styles.passInfo}>
                    <Card height={70} width={79} />
                    <CustomTextDMSans style={styles.upperCase}>
                      {string.upload_photo_id}
                    </CustomTextDMSans>
                  </View>
